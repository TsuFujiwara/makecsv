...
class TermWindow(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        lineLayout.addWidget(QtWidgets.QLabel("開始日時"), 0, 0)
        lineLayout.addWidget(self.s_Y, 0, 1)
        lineLayout.addWidget(QtWidgets.QLabel("年"), 0, 2)
        lineLayout.addWidget(self.s_m, 0, 3)
        lineLayout.addWidget(QtWidgets.QLabel("月"), 0, 4)
        lineLayout.addWidget(self.s_D, 0, 5)
        lineLayout.addWidget(QtWidgets.QLabel("日"), 0, 6)
        lineLayout.addWidget(self.s_H, 0, 7)
        lineLayout.addWidget(QtWidgets.QLabel("時"), 0, 8)
        lineLayout.addWidget(self.s_M, 0, 9)
        lineLayout.addWidget(QtWidgets.QLabel("分"), 0, 10)
        lineLayout.addWidget(self.s_S, 0, 11)
        lineLayout.addWidget(QtWidgets.QLabel("秒"), 0, 12)
        lineLayout.addWidget(QtWidgets.QLabel("終了日時"), 1, 0)
        lineLayout.addWidget(self.e_Y, 1, 1)
        lineLayout.addWidget(QtWidgets.QLabel("年"), 1, 2)
        lineLayout.addWidget(self.e_m, 1, 3)
        lineLayout.addWidget(QtWidgets.QLabel("月"), 1, 4)
        lineLayout.addWidget(self.e_D, 1, 5)
        lineLayout.addWidget(QtWidgets.QLabel("日"), 1, 6)
        lineLayout.addWidget(self.e_H, 1, 7)
        lineLayout.addWidget(QtWidgets.QLabel("時"), 1, 8)
        lineLayout.addWidget(self.e_M, 1, 9)
        lineLayout.addWidget(QtWidgets.QLabel("分"), 1, 10)
        lineLayout.addWidget(self.e_S, 1, 11)
        lineLayout.addWidget(QtWidgets.QLabel("秒"), 1, 12)
        lineLayout.addWidget(QtWidgets.QLabel("下記「Start」ボタンを押すとcsv作成開始"), 2, 0)
        lineLayout.addWidget(QtWidgets.QLabel("下記ボタンが「Finished」になるとcsv作成終了"), 3, 0)
